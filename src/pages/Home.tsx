...
const Home = () => {
  ...
  const OrbitalItem = ({
    ...
    return (
      <div
        ...
        style={{
          transform: `rotate(${angle}deg) translateY(-50%) rotate(-${angle}deg)`,
        }}
      >
        {icon}
      </div>
  ...
  return (
    <div className="grow pt-16 bg-mesh-gradient">
      ...
      <section
        className="relative -mt-40 mb-0 pointer-events-none"
        style={{ zIndex: 20 }}
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <h2 className="text-4xl md:text-6xl font-bold text-brand-primary mb-6 text-center">
              ...
              <span className="text-accent-dark">Real</span>
            </h2>
          </ScrollReveal>

          <ScrollReveal delay={0.1}>
            <p className="text-xl text-brand-primary/80 max-w-3xl mx-auto text-center mb-16">
              Businesses need modern solutions, but many lack the expertise and
              resources to bridge the gap between traditional operations and
            ...
            {[
              {
                value: 65,
                suffix: "%",
                label: "of SMEs lack digital presence",
                icon: TrendingUp,
              },
              {
                value: 500,
              ...
              },
              {
                value: 25,
                suffix: "%",
                label: "annual growth in digital services",
                icon: Sparkles,
              },
              {
                value: 80,
                suffix: "%",
                label: "of businesses need IT support",
                icon: Users,
              },
            ].map((stat, idx) => (
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mb-16 md:mb-24">
          <ScrollReveal>
            ...
            <p className="text-xl text-brand-primary/70 max-w-2xl mx-auto text-center mb-16">
              Our diversified revenue streams reduce risk and maximize growth
              potential
            </p>
          </ScrollReveal>
            ...
            {servicesData.map((service, idx) => (
              <ScrollReveal key={idx} delay={idx * 0.1}>
                <motion.div
                  ...
                  onClick={() =>
                    navigate(`/services/${getServiceSlug(service.name)}`)
                  }
                >
                  <div
                  ...
                  <div className="relative z-10">
                    <div
                      className={`w-16 h-16 ${service.color} rounded-2xl flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform duration-300 shadow-xl`}
                    >
                    ...
                    <p className="text-brand-primary/70 mb-6 group-hover:text-brand-primary transition-colors">
                      {service.desc}
                    </p>
      ...
      <section className="py-24 bg-brand-quaternary/10 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            ...
            <p className="text-xl text-brand-primary/70 max-w-2xl mx-auto text-center mb-16">
              Trusted by businesses seeking innovative, reliable digital
              solutions
            </p>
          </ScrollReveal>
            ...
            {[
              {
                ...
                desc: "Optimized for speed with edge computing capabilities",
                icon: Zap,
                color: "text-brand-primary",
              },
              {
                title: "Secure by Default",
                desc: "Enterprise-grade security with automated compliance",
                icon: Shield,
                color: "text-brand-secondary",
              },
              {
                title: "AI Integration",
                desc: "Built-in AI assistants for instant optimization",
                icon: Sparkles,
                color: "text-accent-light",
              },
              {
                title: "Human-Centered",
                desc: "UX philosophy that puts users first",
                icon: Users,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <h2 className="text-4xl md:text-6xl font-bold text-brand-primary mb-4 text-center">
              ...
              <span className="text-accent-dark">Meowieeee</span>
            </h2>
              ...
              <ScrollReveal key={idx} delay={idx * 0.1}>
                ...
                >
                  ...
                  <div className="text-center">
                    <h3 className="text-xl font-bold text-brand-primary group-hover:text-accent-dark transition-colors mb-1">
                      {member.name}
                    </h3>
                    <p className="text-sm text-brand-primary/70 uppercase tracking-widest">
                      {member.role}
                    </p>
                  </div>
                </motion.div>
      ...
      <section className="py-24 bg-brand-cream relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <h2 className="text-4xl md:text-6xl font-bold text-brand-primary mb-4 text-center">
              Built on Modern{" "}
              <span className="text-accent-dark">Technology</span>
            </h2>
            <p className="text-xl text-brand-primary/70 max-w-2xl mx-auto text-center mb-16">
      ...
      <section
        id="investment"
        className="py-24 bg-brand-quaternary/10 relative"
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <h2 className="text-4xl md:text-6xl font-bold text-brand-primary mb-4 text-center">
              Join Us in Shaping the{" "}
              <span className="text-accent-dark">Future</span>
            </h2>
          </ScrollReveal>
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-start">
                  ...
                  <span className="text-brand-primary/80">
                    ...
                    Massive digital services opportunity
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-6 h-6 text-accent-dark mr-3 mt-1 shrink-0" />
                  <span className="text-brand-primary/80">
                    ...
                    Four scalable service pillars
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-6 h-6 text-accent-dark mr-3 mt-1 shrink-0" />
                  <span className="text-brand-primary/80">
                    <strong className="text-brand-primary">Proven Team:</strong>{" "}
          ...
          <ScrollReveal delay={0.2}>
            <form
              ...
              className="bg-white rounded-3xl p-8 md:p-12 border border-brand-quaternary/20 shadow-xl"
            >
              <h3 className="text-2xl font-bold text-brand-primary mb-6">
                Schedule a Meeting
              </h3>
