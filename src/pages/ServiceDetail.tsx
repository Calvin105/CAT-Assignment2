    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        ...
        <motion.button
          ...
          onClick={() => navigate("/services")}
          className="group mb-12 flex items-center gap-3 px-5 py-2.5 rounded-full bg-white/40 hover:bg-white/60 backdrop-blur-sm transition-all border border-black/5"
        >
