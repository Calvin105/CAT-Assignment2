...
const Services = () => {
  ...
  const colorClasses: {
    [key: string]: { bg: string; border: string; text: string; iconBg: string };
  } = {
    indigo: {
      bg: "bg-indigo-500/10",
          ...
          >
            {services.map((service, idx) => (
              <motion.div
                ...
                className={`bg-slate-900 p-8 rounded-2xl border border-slate-800 hover:${
              ...
              >
                ...
                <motion.div
                  ...
                  className={`w-16 h-16 rounded-xl flex items-center justify-center mb-6 ${
                    colorClasses[service.color].iconBg
                  ...
                  <div className="flex flex-wrap gap-2">
                    {service.techStack.map((tech, tIdx) => (
                      <span
                        ...
                        } ${colorClasses[service.color].text} border ${
                          colorClasses[service.color].border
                        }`}
                      >
                        {tech}
